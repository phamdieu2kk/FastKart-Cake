...
const vnpayController = async (req, res) => {
    try {
        const { cartItems, shippingFee, idCart } = req.body;
        ...
        const vnpayResponse = await vnpay.buildPaymentUrl({
            ...
            vnp_TxnRef: `${idCart} + ${generatePayID()}`, // Sử dụng paymentId thay vì singlePaymentId
            vnp_OrderInfo: `Thanh toan don hang ${idCart}`,
